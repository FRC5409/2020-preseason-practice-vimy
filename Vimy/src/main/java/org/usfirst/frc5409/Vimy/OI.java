...
import org.usfirst.frc5409.Vimy.subsystems.DriveTrain;
...
public class OI {
    ...
    public OI() {
        ...
        joystickButton9.whileHeld(new TankDrive());
        joystickButton8 = new JoystickButton(controlStick, 3);
        joystickButton8.whileHeld(new TankDrive());
        joystickButton7 = new JoystickButton(controlStick, 2);
        joystickButton7.whileHeld(new TankDrive());
        joystickButton6 = new JoystickButton(controlStick, 1);
        joystickButton6.whileHeld(new TankDrive());
        driveStick = new Joystick(0);
        
        joystickButton5 = new JoystickButton(driveStick, 5);
        joystickButton5.whileHeld(new TankDrive());
        joystickButton4 = new JoystickButton(driveStick, 4);
        joystickButton4.whileHeld(new TankDrive());
        joystickButton3 = new JoystickButton(driveStick, 3);
        joystickButton3.whileHeld(new TankDrive());
        joystickButton2 = new JoystickButton(driveStick, 2);
        joystickButton2.whileHeld(new TankDrive());
        joystickButton1 = new JoystickButton(driveStick, 1);
        joystickButton1.whileHeld(new TankDrive());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new TankDrive());
