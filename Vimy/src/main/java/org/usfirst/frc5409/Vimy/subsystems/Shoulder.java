...
public class Shoulder extends PIDSubsystem {
    ...
    private AnalogInput s_xxx_shoulderAbsoluteEncoder;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        ...
        s_xxx_shoulderAbsoluteEncoder = new AnalogInput(0);
        addChild("s_xxx_shoulderAbsoluteEncoder",s_xxx_shoulderAbsoluteEncoder);
    ...
    protected double returnPIDInput() {
        ...
        double sensorPosition = (s_xxx_shoulderAbsoluteEncoder.getVoltage() - 0.5)/4 * 360 - 90;
