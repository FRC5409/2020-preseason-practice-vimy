...
public class Shoulder extends PIDSubsystem {
    ...
    public void periodic() {
        super.periodic();
        positionSensorAngle = (s_shoulderAbsoluteEncoder_A0.getVoltage() - 0.5) / 4 * 360 - 90;
        SmartDashboard.putNumber("Shoulder Angle", positionSensorAngle);
    }
    @Override
